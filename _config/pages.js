...
export default {
	...
	products: {
		...
		layout: require('@imagina/qcommerce/_layouts/productsIndex').default,
	...
	productCreate: {
		...
		layout: require('@imagina/qcommerce/_layouts/productForm').default,
		containerLayout: master,
	...
	categories: {
		...
		layout: require('@imagina/qcommerce/_layouts/productCategories').default,
		containerLayout: master,
	...
	productOptions: {
		...
		layout: require('@imagina/qcommerce/_layouts/productOptions').default,
		containerLayout: master,
	...
	productOptionsValues: {
		...
		layout: require('@imagina/qcommerce/_layouts/productOptionsValues').default,
		containerLayout: master,
