      ...
      <div class="layout-padding relative-position">
        <div class="row gutter-x-md">
          ...
          <div class="col-12 col-md-8" v-if="locale.success">
            ...
            <!--Transaction Key-->
            <q-input v-model="locale.formTemplate.transactionkey"
                     :stack-label="$tr('qcommerce.layout.form.transactionKey')"/>

            <!--Client Key-->
            <q-input v-model="locale.formTemplate.clientkey"
                     :stack-label="$tr('qcommerce.layout.form.clientKey')"/>
          </div>
          <!--Form right-->
