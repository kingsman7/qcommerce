      ...
      <div class="relative-position q-pa-md">
        <q-form @submit="updateItem" class="row q-col-gutter-x-md" ref="formContent" autocomplete="off"
          ...
          <div class="col-12 col-md-8" v-if="locale.success">
            ...
            <!--User-->
            <q-input v-model="locale.formTemplate.user" outlined dense
                     :label="$tr('ui.form.email')"/>

            <!--Pass-->
            <q-input v-model="locale.formTemplate.pass" outlined dense
                     :label="$tr('ui.form.password')"/>

            <!--Token-->
            <q-input v-model="locale.formTemplate.token" outlined dense label="Token"/>
          </div>
          <!--Form right-->
